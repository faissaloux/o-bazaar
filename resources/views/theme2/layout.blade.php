...
<body class="@yield('bodyClass')  @if(auth::check())  has-logged   @endif" >    
            ...
            <div class="container">
                ...
                <div class="header__content-right">
                    <div class="header__actions">
                        ...
                        <div class="ps-cart--mini"><a class="header__extra" href="{{ route('cart' ,[  'store' => $store] ) }}"><i class="icon-bag2"></i><span><i>{{ ShoppingCart::count(false) }}</i></span></a>
    ...
    <div class="navigation--list">
        <div class="navigation__content"><a class="navigation__item ps-toggle--sidebar" href="#menu-mobile"><i class="icon-menu"></i><span> Menu</span></a><a class="navigation__item ps-toggle--sidebar" href="#navigation-mobile"><i class="icon-list4"></i><span> Categories</span></a><a class="navigation__item ps-toggle--sidebar" href="#search-sidebar"><i class="icon-magnifier"></i><span> Search</span></a><a class="navigation__item ps-toggle--sidebar" href="#cart-mobile"><i class="icon-bag2"></i><span> Cart</span></a><a class="navigation__item ps-toggle--sidebar" onclick="window.location.href = '/';" href="/"><i class="icon-home"></i><span> Home</span></a></div>
    </div>
