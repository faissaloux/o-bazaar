...
fieldset.content-group.pagetitle h1 {
    text-align: center;
}
...
.form-group--icon i {padding-top: 25px;}
...
<div class="ps-page--single">
    <div class="ps-vendor-banner bg--cover" data-background="https://i.imgur.com/xN98BVZ.jpg">
        <div class="container">
            <h2>Millions Of Shoppers Can’t Wait To See What You Have In Store</h2><a class="ps-btn ps-btn--lg" href="#joinform">Start Selling</a>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <div class="ps-block--icon-box-2">
                            <div class="ps-block__thumbnail"><img src="https://i.imgur.com/retBAik.png" alt=""></div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <div class="ps-block--icon-box-2">
                            <div class="ps-block__thumbnail"><img src="https://i.imgur.com/duuhnL2.png" alt=""></div>
                            <div class="ps-block__content">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <div class="ps-block--icon-box-2">
                            <div class="ps-block__thumbnail"><img src="https://i.imgur.com/TDgN4GO.png" alt=""></div>
                            <div class="ps-block__content">
                                <h4>Support 24/7</h4>
                                <div class="ps-block__desc" data-mh="about-desc">
                                    <p>Our tools and services make it easy to manage, promote and grow your business.</p>
        ...
        <div class="container">
            ...
            <div class="ps-section__content">
                <div class="ps-block--vendor-milestone">
                    ...
                    <div class="ps-block__right"><img src="https://i.imgur.com/C6Iq0HR.png" alt=""></div>
                ...
                <div class="ps-block--vendor-milestone reverse">
                    ...
                    <div class="ps-block__right"><img src="https://i.imgur.com/j7pQ73g.png" alt=""></div>
                ...
                <div class="ps-block--vendor-milestone">
                    ...
                    <div class="ps-block__right"><img src="https://i.imgur.com/ny5s5CA.png" alt=""></div>
                ...
                <div class="ps-block--vendor-milestone reverse">
                    ...
                    <div class="ps-block__right"><img src="https://i.imgur.com/yqEs6HD.png" alt=""></div>
    ...
    <div class="ps-section--vendor ps-vendor-best-fees">
        <div class="container">
            ...
            <div class="ps-section__content">
                ...
                <div class="ps-section__highlight"><img src="https://i.imgur.com/Ul3JYnW.png" alt="">
                    <figure>
    ...
    <div class="ps-section--vendor ps-vendor-faqs">
        <div class="container">
            ...
            <div class="ps-section__footer">
                <p>Still have more questions? Feel free to contact us.</p><a class="ps-btn" href="/contact-us">Contact Us</a>
            </div>
        </div>
    </div>
</div>
