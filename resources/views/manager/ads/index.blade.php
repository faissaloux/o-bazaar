    ...
    <div class="page-header page-header-transparent">
        <div class="page-header-content">
            ...
            <div class="heading-elements div_btn">
                ...
                <a href="{{ route('manager.ads.create') }}" class="btn bg-blue btn-labeled heading-btn btn_add"><b><i class="icon-plus3"></i></b>
                {{ __('create new ad') }}
                </a>
...
<ul class="breadcrumb">
    ...
    <div class="content">
        ...
        <div class="empty_state text-center">
            ...
            <a href="{{ route('manager.ads.create') }}" class="btn bg-blue btn-labeled heading-btn"><b><i class="icon-plus3"></i></b>
                {{ __('create new ad') }}
             </a>
...
@if (!$ads->isEmpty())
        <div class="panel panel-flat table-panel table-responsive">
            ...
            <td data-label="{{ __('edit ') }}">
                ...
                <li>
                <a href="{{ route('manager.ads.edit',['id' => $ad->id]) }}" class="text-primary-600">
                <i class="icon-pencil7 position-left"></i>{{ __('Edit') }} 
                </a>
                </li>
                <li>
                <a href="{{ route('manager.ads.delete',['id' => $ad->id]) }}" class="text-danger-600">
                <i class="icon-cross2 position-left"></i>{{ __('Delete') }}
                </a>
                </li>
                <li>
                <a href="{{ route('manager.ads.duplicate',['id' => $ad->id]) }}" class="text-bg-info">
