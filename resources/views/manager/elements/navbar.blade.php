...
<div class="navbar navbar-inverse">
    <div class="navbar-header">
        <a class="navbar-brand" href="{{ route('manager.home') }}">{{ __('control panel') }}</a>
    ...
    <div class="navbar-collapse collapse" id="navbar-mobile">
        <ul class="nav navbar-nav">
            ...
            <li>
                <a class="goout" target="_blank" href="{{ route('base') }}">
                    <i class="icon-enter"></i> {{ __('visite website') }}</a>
            </li>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown dropdown-user">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    <li><a href="{{ route('manager.account') }}"><i class="icon-cog5"></i> {{ __('account settings') }}</a></li>
                    <li><a href="{{ route('manager.logout') }}"><i class="icon-switch2"></i>{{ __('logout') }}</a></li>
                </ul>
            </li>
        </ul>
    </div>
